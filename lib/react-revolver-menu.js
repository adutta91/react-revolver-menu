...
/***/ function(module, exports, __webpack_require__) {
	...
	// var ReactRevolverMenu = require('./lib/react-revolver-menu.js');
	...
	var _srcReactRevolverMenuJsx = __webpack_require__(2);

	var _srcReactRevolverMenuJsx2 = _interopRequireDefault(_srcReactRevolverMenuJsx);

	exports['default'] = _srcReactRevolverMenuJsx2['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactRevolverMenu = (function (_Component) {
	  _inherits(ReactRevolverMenu, _Component);

	  function ReactRevolverMenu(props) {
	    _classCallCheck(this, ReactRevolverMenu);

	    _get(Object.getPrototypeOf(ReactRevolverMenu.prototype), 'constructor', this).call(this, props);
	    this.state = {
	      showStyle: {},
	      subItems: [],
	      timeout: false,
	  ...
	  _createClass(ReactRevolverMenu, [{
	    ...
	    key: 'startTimeout',
	    value: function startTimeout(cb) {
	      var _this = this;

	      this.timeout = setTimeout(function () {
	        if (_this.state.timeoutCb) _this.state.timeoutCb();
	        _this.setStyles(true);
	    ...
	    key: 'setStyles',
	    value: function setStyles(val) {
	      var _this2 = this;

	      var items = this.state.subItems.length ? this.state.subItems : this.props.items;
	      var showStyle = _lodash2['default'].clone(this.state.showStyle);
	      var duration = this.props.animateDelay || 0;

	      var styleCb = function styleCb(idx) {
	        showStyle[idx] = val;
	        _this2.setState({ showStyle: showStyle });
	      };

	      _lodash2['default'].forEach(items, function (item, idx) {
	        if (duration) {
	          setTimeout(styleCb.bind(_this2, idx), idx * duration);
	        } else styleCb(idx);
	      });
	    }
	  }, {
	    ...
	    key: 'setOnHover',
	    value: function setOnHover(idx, val) {
	    ...
	    value: function circleStyle() {
	      var width = parseInt(this.props.diameter) || 12;
	    ...
	    value: function renderItem(item, idx) {
	      ...
	      var style = this.getStyle(item, interval, idx);
	    ...
	    key: 'itemSwitchBoard',
	    value: function itemSwitchBoard(item, props, idx) {
	      var popover = this.renderPopover(item, idx);
	      switch (item.type) {
	        case 'img':
	    ...
	    key: 'renderPopover',
	    value: function renderPopover(item, idx) {
	      if (item.popover) {
	        ...
	        if (this.state.hovered[idx]) {
	          ...
	          switch (item.popoverPosition) {
	            case 'top':
	              break;className += ' top';
	            case 'bottom':
	              break;className += ' bottom';
	            case 'right':
	              break;className += ' right';
	            case 'left':
	              break;className += ' left';
	            default:
	              break;className += ' bottom';
	          }
	          if (item.popoverPosition == 'top') className += ' top';else className += ' bottom';
	        }
	    ...
	    value: function renderItems() {
	      ...
	      return _lodash2['default'].map(items, function (item, idx) {
	        return _this5.renderItem(item, idx);
	      });
	    }
	  }, {
	    key: 'renderCenter',
	    value: function renderCenter() {
	      ...
	      if (!this.state.history.length) {
	        ...
	        center = this.props;
	        _lodash2['default'].forEach(this.state.history, function (idx) {
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'div',
	          { style: this.circleStyle(), className: 'circle-container ' + (this.state.showStyle ? 'show' : '') },
	          this.renderItems(),
	          this.renderCenter()
	        )
	      );
	  ...
	  return ReactRevolverMenu;
	})(_react.Component);

	exports['default'] = ReactRevolverMenu;
	;
	...
	ReactRevolverMenu.propTypes = {
	  items: _propTypes2['default'].arrayOf(_propTypes2['default'].shape({
	    ...
	    popoverPosition: _propTypes2['default'].oneOf(['top', 'bottom', 'left', 'right']),
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/sass-loader/index.js?outputStyle=expanded&includePaths[]=/projects/react-revolver-menu/bower_components&includePaths[]=/projects/react-revolver-menu/node_modules!./react-revolver-menu.scss", function() {
				var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/sass-loader/index.js?outputStyle=expanded&includePaths[]=/projects/react-revolver-menu/bower_components&includePaths[]=/projects/react-revolver-menu/node_modules!./react-revolver-menu.scss");
